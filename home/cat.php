...
<div class="col-sm-3 col-12">
  ...
  <a href="#" id="lists" class="list-group-item list-group-item-action">
    ...
    $Item_Name=$_GET["ItemName"];
      $inset=$conn->query("select * from product_information where Item_Name='$Item_Name'");
      while($fetcharry=$inset->fetch_array())
      {
   ?>
          ...
          <div class="col-sm-3 col-12" style="margin-top: 10px;">
            <div>
              <center>
                ...
                <span class="name"><a href="more_details.php?id=<?php echo $fetcharry[2];?>"><?php echo $fetcharry[3];?></a></span><br>
